...
Apply the same vertical RED-GREEN-REFACTOR discipline defined by the top-level `code-development` Skill: observe a representative baseline failure, make the smallest instruction change, and rerun the same scenario before broadening the Skill.
...
- ✅ Good: `**REQUIRED SUB-SKILL:** Use code-development`
- ✅ Good: `**REQUIRED BACKGROUND:** Apply the vertical TDD contract from code-development`
- ❌ Bad: `See skills/testing/some-method` (unclear if required)
- ❌ Bad: `@skills/testing/some-method/SKILL.md` (force-loads, burns context)
...
**REQUIRED BACKGROUND:** The top-level `code-development` Skill owns the shared vertical TDD and verification method. The same principles apply to process documentation.
...
**Examples:** TDD, evidence-before-claims, designing-before-coding
