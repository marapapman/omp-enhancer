...
For the broader routing decision of when a capability should be a rule, a skill, MCP, or a plain CLI/API workflow, see the optional repository-local `docs/capability-surface-selection.md` document when it is present.
