...
description: "Java coding standards for Spring Boot and Quarkus services, covering naming, immutability, Optional usage, streams, exceptions, generics, CDI, reactive patterns, and project layout. Use when writing or reviewing Java code where these conventions are relevant; identify the active framework before choosing its specific guidance."
origin: ECC
---
