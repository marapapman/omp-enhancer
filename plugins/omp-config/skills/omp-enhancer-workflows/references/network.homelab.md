...
- Reference steps:
  ...
  8. [step-audit] ecc-network-config-reviewer independently reviews the produced design or plan against validation and safety evidence without applying configuration; Main integrates findings
