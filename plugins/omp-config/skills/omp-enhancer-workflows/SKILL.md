...
- `visual` — Diagrams (Mermaid), UI/UX design, visual artifacts, slides with visual layout, or rendered figure review. D=[`skill://mermaid-diagram`, `skill://svg-flowchart`, `skill://frontend-design`, `skill://canvas-design`]. Reference: `skill://omp-enhancer-workflows/references/visual.md`.
