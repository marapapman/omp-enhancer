...
- `visual` — Diagrams (draw.io), UI/UX design, static visual artifacts, or rendered figure review. D=[`skill://drawio-skill`, `skill://frontend-design`, `skill://canvas-design`, `skill://format-humanizer`, `skill://zh-format-humanizer`]. Reference: `skill://omp-enhancer-workflows/references/visual.md`.
