...
SVG is one of three acceptable roles here, never a replacement for the diagram primary:

1. **Icon asset** — a small monochrome SVG pictogram embedded as a node icon in the diagram figure.
