...
7. For static canvas and export renders, check clipping, legibility, hierarchy, focal point, reading order, alignment, spacing, contrast, image treatment, export fidelity, and whether the composition survives the reduced preview.
...
- affected page number for slides, viewport and state for UI, and artifact and region for static canvas
