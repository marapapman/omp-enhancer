...
export default function registerTikzHelper(omp) {
  ...
  omp.registerTool({
    ...
    promptGuidelines: [
      ...
      'Set elk.direction to RIGHT or DOWN. Set generous spacing with elk.spacing.nodeNode, and for layered graphs also elk.layered.spacing.nodeNodeBetweenLayers and elk.layered.spacing.edgeNodeBetweenLayers. Set elk.edgeRouting to ORTHOGONAL for layered graphs; stress and force use POLYLINE or SPLINES.',
