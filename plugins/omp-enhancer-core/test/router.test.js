...
test('routes writing workflow edge cases with correct complexity gates', () => {
  ...
  const writingCases = [
    ...
    ['copy file edit remains implementation', '修改 src/i18n/zh.json 里的空状态文案并跑测试。', 'implementation-with-tests', null, ['plan', 'task', 'reviewer']],
    ['latex text file edit remains implementation', '润色 main.tex 里的 related work 段落并重新编译。', 'implementation-with-tests', null, ['plan', 'task', 'reviewer']],
    ...
    ['readme file edit remains implementation', 'Polish README.md installation wording and save the changes.', 'implementation-with-tests', null, ['plan', 'task', 'reviewer']],
    ['comment file translation remains implementation', 'Translate comments in src/router.js to English and run tests.', 'implementation-with-tests', null, ['plan', 'task', 'reviewer']],
    ...
    ['writing tool failure remains implementation', 'Fix the writing_quality_check tool failure and add regression tests.', 'implementation-with-tests', null, ['plan', 'task', 'reviewer']],
  ];
