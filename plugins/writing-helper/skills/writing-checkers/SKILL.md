...
9. **Flag AI writing tells with evidence.** Any listed tell justifies a finding at its first sighting — prefer an over-correction to a miss. Leave phrases alone inside quotations, titles, or proper names. Never recommend deleting semantic anchors to remove a tell.
