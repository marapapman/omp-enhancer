...
当前 workflow catalog version 43 只有 3 个 ID：`writing`、`research` 和 `visual`。
...
- `id` 全局唯一、稳定、小写；catalog v43 只有 3 个 ID（`writing`、`research`、`visual`）；
