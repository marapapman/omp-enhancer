...
| `plugins/omp-enhancer-core/src/workflows/` | Workflow catalog (v30), schema, renderers, definitions (code, writing, research, network, database, ml, growth, operations) |
...
| `plugins/omp-enhancer-core/src/workflows/catalog.js` | Workflow catalog v30: assembles all domain workflow definitions |
