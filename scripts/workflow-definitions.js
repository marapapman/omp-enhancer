...
export const WORKFLOW_CATALOG_VERSION = 42;
...
const visualWorkflows = [
  {
    ...
    suggestedFlow: [
      ...
      'task applies at most one fix round for supported findings and re-exports; when the fix round is the last edit, Main may run the mechanical final export (the drawio -e -s 2 command plus the skill PNG repair step) without editing the source; deliver the .drawio source with the exported image.',
