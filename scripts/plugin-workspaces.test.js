...
test('canonical inventory lists the six plugin workspaces in order', () => {
  assert.deepEqual(
    ...
    [
      ...
      { name: 'commandcode', workspace: 'plugins/commandcode' },
      { name: 'aliyun-bailian-token-plan', workspace: 'plugins/aliyun-bailian-token-plan' },
    ],
  )
})
