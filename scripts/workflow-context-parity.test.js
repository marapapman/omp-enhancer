...
test('catalog v39 defines exactly the three advisory workflows (writing, research, visual)', () => {
  assert.equal(WORKFLOW_CATALOG_VERSION, 39);
...
test('packaged catalog, index, and all references expose catalog v39 advisory content', async () => {
  ...
  assert.match(catalog, /# OMP Enhancer Workflow Catalog v39/);
