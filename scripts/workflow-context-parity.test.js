...
test('catalog v42 defines exactly the three advisory workflows (writing, research, visual)', () => {
  assert.equal(WORKFLOW_CATALOG_VERSION, 42);
...
test('packaged catalog, index, and all references expose catalog v42 advisory content', async () => {
  ...
  assert.match(catalog, /# OMP Enhancer Workflow Catalog v42/);
