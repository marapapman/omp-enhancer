...
const MARKETPLACE_DESCRIPTION = 'OMP enhancement plugins for optional workflow references, shared config context, writing, fact checking, editable draw.io diagrams, Volcengine Ark Coding Plan, and Alibaba Cloud Bailian Token Plan model integration.'
