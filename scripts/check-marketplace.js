...
const MARKETPLACE_DESCRIPTION = 'OMP enhancement plugins for optional workflow references, shared config context, writing, fact checking, editable draw.io diagrams, Command Code, Volcengine Ark Coding Plan, and Alibaba Cloud Bailian Token Plan model integration.'

const PLUGIN_CATEGORIES = Object.freeze({
  'omp-config': 'development',
  'writing-helper': 'writing',
  'omp-fact-checker': 'development',
  'volcengine-coding-plan': 'development',
  'commandcode': 'development',
  'aliyun-bailian-token-plan': 'development',
})
